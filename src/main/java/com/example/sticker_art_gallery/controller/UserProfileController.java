...
public class UserProfileController {
    ...
    @Operation(
        ...
        description = "Обновляет профиль пользователя по ID профиля. Доступно только администраторам. Можно обновлять роль, статус блокировки и статус подписки. Баланс ART изменяется только через ART-транзакции."
    )
    @ApiResponses(value = {
