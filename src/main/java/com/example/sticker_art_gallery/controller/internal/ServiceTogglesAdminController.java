...
@Tag(name = "Service Toggles Admin API", description = "Просмотр текущих конфигурационных toggles сервиса")
public class ServiceTogglesAdminController {

    private final AppConfig appConfig;

    public ServiceTogglesAdminController(AppConfig appConfig) {
